...
- **Does:** Player floor-market engine — 15 markets: anytime goalscorer, shots O0.5/1.5/2.5, SoT O0.5/1.5, fouls O0.5/1.5, fouled O0.5, tackles O0.5/1.5/2.5, passes completed O19.5/29.5/39.5. Empirical leak-free per-90 priors (expanding mean over prior 60+min matches, groupby.transform — never g.apply) × projected minutes → Poisson tail (negative binomial for passes, fitted dispersion r≈10; measured over-dispersion 4.25x), out-of-fold isotonic on ECE-flagged markets, possession-context multiplier on passes (β=0.5, validated 8/8 season cells 2026-06-11). The old 10-CatBoost stack was deleted 2026-06-04 (died on within-position control).
