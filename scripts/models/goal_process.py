...
def market_outcomes(p: dict) -> dict:
    ...
    o = {
        ...
        "1h_btts": (p["ht_home"] >= 1) & (p["ht_away"] >= 1),
        "ht_dc_1x": p["ht_home"] >= p["ht_away"], "ht_dc_x2": p["ht_away"] >= p["ht_home"], "ht_dc_12": p["ht_home"] != p["ht_away"],
...
MARKET_LABELS = {
    ...
    "1h_btts": ("Tempi", "Goal 1° tempo", "Sì", "No"),
    "ht_dc_1x": ("Tempi", "Doppia chance 1° tempo", "1X", None), "ht_dc_x2": ("Tempi", "Doppia chance 1° tempo", "X2", None), "ht_dc_12": ("Tempi", "Doppia chance 1° tempo", "12", None),
