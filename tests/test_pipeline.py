...
def test_imports():
    ...
    modules = [
        ...
        ("scripts.realtime_prediction_engine", "Prediction Engine"),
        ("scripts.prediction.sentiment_analyzer", "Sentiment Analyzer"),
        ("scripts.analysis.player_analyzer", "Player Analyzer"),
        ("scripts.analysis.formation_analyzer", "Formation Analyzer"),
        ...
        ("scripts.betting_engine", "Betting Engine"),
        ("scripts.advanced_betting_engine", "Advanced Betting Engine"),
        ...
        ("scripts.live_betting", "Live Betting"),
